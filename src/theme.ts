...
export const brand = {
  ...
  peach: '#E39F76',
  peachSoft: '#F6EEE6',
  peachGlow: 'rgba(227, 159, 118, 0.20)',
  graphite: '#1C231E',
  graphiteSoft: '#12190f',
  white: '#FFFFFF',
  beige: '#F4F5F0',
  ...
  surfaceWarm: '#F4F6F1',
  border: '#ECEEE8',
  shadow: '0 4px 20px rgba(28, 35, 30, 0.05)',
  shadowHover: '0 18px 48px rgba(28, 35, 30, 0.10)',
  shadowGreen: '0 12px 28px rgba(47, 125, 83, 0.20)',
  touchMin: 44,
