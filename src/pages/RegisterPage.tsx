...
export default function RegisterPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    localStorage.setItem('plantyhub_user', JSON.stringify({ name: name.trim(), email: email.trim() }))
    setSubmitted(true)
  }
  ...
  return (
    <AuthPageLayout eyebrow={t('auth.register.eyebrow')} title={t('auth.register.title')} subtitle={t('auth.register.subtitle')}>
      <Stack component="form" onSubmit={handleSubmit} spacing={2}>
        ...
        <Button type="submit" variant="contained" size="large" fullWidth startIcon={<PersonAddRounded />}>
