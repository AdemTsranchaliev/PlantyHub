      ...
      <Grid container spacing={2} sx={{ mb: 2 }}>
        <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
          <AdminStatCard
            ...
            value={formatEuro(dashboardStats.totalRevenue)}
            icon={<EuroRounded />}
            trend={trendLabel(dashboardStats.revenueTrend)}
            trendUp
          />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
          <AdminStatCard
            ...
            trend={trendLabel(dashboardStats.ordersTrend)}
            trendUp
          />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
          <AdminStatCard
            ...
            value={formatEuro(dashboardStats.avgOrderValue)}
            icon={<TrendingUpRounded />}
            trend={trendLabel(dashboardStats.avgOrderTrend)}
            trendUp
          />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
      ...
      <Grid container spacing={2} sx={{ mb: 3 }}>
        ...
        <Grid size={{ xs: 6, sm: 3 }}>
          <AdminStatCard
            ...
            value={mockNewsletterSubscribers.toLocaleString()}
            icon={<MailRounded />}
        ...
        <Grid size={{ xs: 6, sm: 3 }}>
          <AdminStatCard
            ...
            trend={trendLabel(dashboardStats.conversionTrend)}
            trendUp
          />
        </Grid>
      </Grid>
