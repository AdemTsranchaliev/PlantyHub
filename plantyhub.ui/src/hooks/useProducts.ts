...
export function useProductStore() {
  ...
  return {
    state,
    loading: useSyncExternalStore(subscribeProducts, getProductsLoading, getProductsLoading),
    error: useSyncExternalStore(subscribeProducts, getProductsError, getProductsError),
    updateProduct,
    addProduct,
    deleteProduct,
    resetProductsState,
...
export function useProductsBootstrap(admin = false) {
  useEffect(() => {
    void loadProducts(admin)
  }, [admin])
}
